...
const FAQS = [
  {
    ...
    a: "We restrict actions based on roles: Warehouse Staff handle stock scans and adjustments, Purchase Managers coordinate supplier relationships and POs, while Admins retain exclusive access to global valuation, warehouse additions, and audit trails.",
  },
  {
